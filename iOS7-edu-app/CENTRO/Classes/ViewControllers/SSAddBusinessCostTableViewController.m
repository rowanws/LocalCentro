//
//  SSAddBusinessCostTableViewController.m
//  CENTRO
//
...
@interface SSAddBusinessCostTableViewController () <NSFetchedResultsControllerDelegate> {
...
@implementation SSAddBusinessCostTableViewController
...
-(void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if([segue.identifier isEqualToString:@"AddBusinessBudgetDetail"]) {
        ...
        CompanyCost *cc = (CompanyCost *) [_fetchedResultsController objectAtIndexPath:self.selectedIndexPath];
        
        [addEditBusinessCostViewController setCompanyCost:cc];
        [addEditBusinessCostViewController setEditingExistingCost:NO];
    }
}
...
{
    static NSString *CellIdentifier = @"AddBusinessCostCell";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self performSegueWithIdentifier:@"AddBusinessBudgetDetail" sender:self];
}
