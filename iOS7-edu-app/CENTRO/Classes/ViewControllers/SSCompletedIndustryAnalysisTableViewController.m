//
//  SSCompletedIndustryAnalysisTableViewController.m
//  CENTRO
//
...
#import "SSCompletedIndustryAnalysisTableViewController.h"
#import "SSUser.h"
#import "Industry.h"
#import "IndustryAndSegment.h"

@interface SSCompletedIndustryAnalysisTableViewController ()
...
@implementation SSCompletedIndustryAnalysisTableViewController
...
- (IBAction)tryAgainButtonPressed:(id)sender {
    [[SSUser currentUser] setActivityNumberAsIncompleted:@"12"];
    
    UIStoryboard *profileStoryBoard = [UIStoryboard storyboardWithName: @"industry" bundle:Nil];
...
{
    static NSString *CellIdentifier = @"CompletedIndustryAnalysisCell";
