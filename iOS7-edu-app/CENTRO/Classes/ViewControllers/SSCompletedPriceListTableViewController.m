//
//  SSCompletedPriceListTableViewController.m
//  CENTRO
//
...
#import "SSCompletedPriceListTableViewController.h"
#import "Category.h"
#import "Product.h"
#import "SSUser.h"

@interface SSCompletedPriceListTableViewController () <NSFetchedResultsControllerDelegate> {
...
@implementation SSCompletedPriceListTableViewController
...
- (IBAction)tryAgainButtonPressed:(id)sender {
    [[SSUser currentUser] setActivityNumberAsIncompleted:@"16"];
    
    UIStoryboard *profileStoryBoard = [UIStoryboard storyboardWithName: @"price_list" bundle:Nil];
...
{
    static NSString *CellIdentifier = @"CompletedPriceListCell";
