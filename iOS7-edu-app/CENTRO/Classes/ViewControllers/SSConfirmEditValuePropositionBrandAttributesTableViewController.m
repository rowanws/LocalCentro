//
//  SSConfirmEditValuePropositionBrandAttributesTableViewController.m
//  CENTRO
//
...
#import "SSConfirmEditValuePropositionBrandAttributesTableViewController.h"
#import "BrandAttribute.h"
#import "SSUser.h"

@interface SSConfirmEditValuePropositionBrandAttributesTableViewController () <NSFetchedResultsControllerDelegate> {
...
@implementation SSConfirmEditValuePropositionBrandAttributesTableViewController
...
- (void)viewDidLoad
{
    ...
    self.titleLabel.text = @"Congrats! Here are your brand attributes.";
...
{
    static NSString *CellIdentifier = @"BrandAttibutesVP";
      ...
      toIndexPath:(NSIndexPath *)destinationIndexPath;
{
    ...
    {
        [mo setValue:[NSNumber numberWithInt:i++] forKey:@"brandValuePropositionRank"];
    }
