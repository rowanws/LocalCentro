//
//  SSCoreCompetenciesViewController.m
//  CENTRO
//
...
#import "SSCoreCompetenciesViewController.h"
#import "SSUser.h"
...
@interface SSCoreCompetenciesViewController ()
...
@implementation SSCoreCompetenciesViewController
...
- (void)viewDidLoad
{
    ...
    self.titleLabel.text = [NSString stringWithFormat:@"Congrats! You've identified %@'s core competencies.", [SSUtils companyName]];
