...
@interface SSProductListTableViewController () <NSFetchedResultsControllerDelegate> {
...
@implementation SSProductListTableViewController
...
- (void)viewDidLoad
{
    ...
    self.congratsLabel.text = [NSString stringWithFormat:@"Well done! You've created %@'s list of products and services.", [SSUtils companyName]];
