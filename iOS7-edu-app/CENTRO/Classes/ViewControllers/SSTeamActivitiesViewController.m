//
//  SSTeamActivitiesViewController.m
//  CENTRO
//
...
#import "SSTeamActivitiesViewController.h"
#import "SSUser.h"
#import "Company.h"
#import "Employee.h"
...
@interface SSTeamActivitiesViewController ()
...
@implementation SSTeamActivitiesViewController
...
- (IBAction)doneButtonPressed:(id)sender {
    ...
    [[SSUser currentUser] setActivityNumberAsCompleted:@"23" andSyncStatus:NO];
...
- (void)viewDidLoad
{
    ...
    self.titleLabel.text = [NSString stringWithFormat:@"Well done! Here are %@'s key activities.", [SSUtils companyName]];
